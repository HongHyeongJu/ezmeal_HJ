...
public class ProductDiscountDao {
    ...
    public boolean equals(Object o) {
        ...
        ProductDiscountDao that = (ProductDiscountDao) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(dc_cd, cate_cd, typ, name, start_dt, end_dt, target, rate, prc, use_yn, del_yn, rmk, in_dtm, in_id, up_dtm, up_id);
    }

    /*-------------------------------------------------------------------*/

    public ProductDiscountDao(String dc_cd, String cate_cd, String typ, String name,
